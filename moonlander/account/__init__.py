...
class LocalAccount():
    ...
    def buy(self, entry_capital, entry_price, stop_loss=0, commission=0):
    ...
    def sell(self, percent, current_price, stop_loss = math.inf, commission=0):
        if percent > 1 or percent < 0: 
            ...
            if self.active_position:
                ...
                if commission > 0:
                    ...
                    self.buying_power += round((closing_position_price - closing_position_price * commission), 2)
                else:
